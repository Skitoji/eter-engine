...
CATALOGO_MONSTRUOS: Dict[str, MonstruoDef] = {
    ...
    "goblin": MonstruoDef(
        nombre="Goblin", tier=1, tipo=TipoMonstruo.HUMANOIDE, vida=20, ataque=5, defensa=0, agilidad=8,
        drops={"oreja_goblin": 0.8},
        descripcion="Clásico indiscutible. Se organiza en hordas primitivas en las periferias.",
    ),
    "slime": MonstruoDef(
        nombre="Slime", tier=1, tipo=TipoMonstruo.ABERRACION, vida=25, ataque=4, defensa=2, agilidad=2,
    ...
    "lobo_gigante": MonstruoDef(
        nombre="Lobo Gigante", tier=1, tipo=TipoMonstruo.BESTIA, vida=30, ataque=8, defensa=1, agilidad=12,
        drops={"piel_lobo": 0.7},
    ...
    "orco": MonstruoDef(
        nombre="Orco", tier=2, tipo=TipoMonstruo.HUMANOIDE, vida=60, ataque=12, defensa=2, agilidad=6,
    ...
    "hombre_lagarto": MonstruoDef(
        nombre="Hombre-Lagarto", tier=2, tipo=TipoMonstruo.HUMANOIDE, vida=55, ataque=11, defensa=2, agilidad=9,
    ...
    "esqueleto": MonstruoDef(
        nombre="Esqueleto", tier=2, tipo=TipoMonstruo.NO_MUERTO, vida=40, ataque=9, defensa=1, agilidad=7,
        drops={"hueso_no_muerto": 0.7},
        descripcion="Resultado clásico de la necromancia. Abunda donde la fe ha colapsado.",
    ),
    "zombi": MonstruoDef(
        nombre="Zombi", tier=2, tipo=TipoMonstruo.NO_MUERTO, vida=50, ataque=10, defensa=2, agilidad=3,
        drops={"hueso_no_muerto": 0.7},
        descripcion="Carne animada por la descomposición mágica y la Generación Oscura.",
    ),
    "cultista": MonstruoDef(
        nombre="Cultista", tier=2, tipo=TipoMonstruo.CORRUPTO, vida=45, ataque=12, defensa=1, agilidad=8,
    ...
    "minotauro": MonstruoDef(
        nombre="Minotauro", tier=3, tipo=TipoMonstruo.BESTIA, vida=120, ataque=22, defensa=4, agilidad=5,
        drops={"cuerno_minotauro": 0.45},
        descripcion="Bestia colosal que custodia ruinas antiguas y pasos montañosos.",
    ),
    "aracne": MonstruoDef(
        nombre="Aracne", tier=3, tipo=TipoMonstruo.ABERRACION, vida=90, ataque=18, defensa=3, agilidad=10,
    ...
    "espectro": MonstruoDef(
        nombre="Espectro", tier=3, tipo=TipoMonstruo.NO_MUERTO, vida=80, ataque=20, defensa=2, agilidad=11,
    ...
    "banshee": MonstruoDef(
        nombre="Banshee", tier=4, tipo=TipoMonstruo.NO_MUERTO, vida=110, ataque=28, defensa=2, agilidad=12,
        drops={"ectoplasma": 0.6},
        descripcion="Lamento que drena la energía espiritual de quien lo escucha.",
    ),
    "quimera": MonstruoDef(
        nombre="Quimera", tier=4, tipo=TipoMonstruo.ABERRACION, vida=180, ataque=32, defensa=5, agilidad=9,
        drops={"sangre_quimera": 0.4},
        descripcion="Híbrido aberrante creado por experimentos arcanos o mutación demoníaca.",
    ),
    "wyvern": MonstruoDef(
        nombre="Wyvern", tier=4, tipo=TipoMonstruo.DRAGON, vida=200, ataque=30, defensa=4, agilidad=14,
    ...
    "dragon": MonstruoDef(
        nombre="Dragón", tier=5, tipo=TipoMonstruo.DRAGON, vida=500, ataque=50, defensa=8, agilidad=10,
